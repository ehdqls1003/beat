...
public class Comment_Adapter extends RecyclerView.Adapter<Comment_Adapter.ViewHolder> {
    ...
    private ArrayList<Feed_comment> mData = null ;
    String id;
    ...
    Comment_Adapter(ArrayList<Feed_comment> list) {
        mData = list ;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull Comment_Adapter.ViewHolder holder, final int position) {

        final Feed_comment item = mData.get(position) ;
