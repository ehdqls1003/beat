...
public class My_flow_Adapter extends RecyclerView.Adapter<My_flow_Adapter.ViewHolder> {
    ...
    My_flow_Adapter(ArrayList<Flow_Item> list,ArrayList<Flow_Item> list2) {
        mData = list ;
        mData2 = list2 ;
    }
    ...
    @Override
    public My_flow_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;

        View view = inflater.inflate(R.layout.recycler_view_item_my_flow, parent, false) ;
        My_flow_Adapter.ViewHolder vh = new My_flow_Adapter.ViewHolder(view) ;
    ...
    @Override
    public void onBindViewHolder(@NonNull My_flow_Adapter.ViewHolder holder, int position) {
        ...
        holder.name.setText(item.getMy_id());
        ...
        for (int i = 0; i < mData2.size(); i++){
            ...
            if (item.getMy_id().equals(mData2.get(i).getFriend_id())){
                flow = true;
                break;
            }
        }
        Log.e("호","flow"+flow);
        if (!item.getMy_id().equals(id)){
            if (flow){
        ...
        if (mListener != null) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    mListener.onItemClicked(item.getMy_id());
                    Log.e("팔로우",item.getMy_id());
            ...
            holder.follow.setOnClickListener(new View.OnClickListener(){
                ...
                @Override
                public void onClick(View v) {
                mListener.onfollowClicked(pos,item.getMy_id());
            ...
            holder.following.setOnClickListener(new View.OnClickListener(){
                ...
                @Override
                public void onClick(View v) {
                    mListener.onfollowingClicked(pos,item.getMy_id());
