...
public class ranklist_Adapter extends RecyclerView.Adapter<ranklist_Adapter.ViewHolder> {
    ...
    ranklist_Adapter(ArrayList<Recent_Main_Item> list) {
        mData = list ;
    }


    @Override
    public ranklist_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;

        View view = inflater.inflate(R.layout.recycler_view_item_ranklist, parent, false) ;
        ranklist_Adapter.ViewHolder vh = new ranklist_Adapter.ViewHolder(view) ;

        return vh ;
    }

            @Override
            public void onBindViewHolder(@NonNull ranklist_Adapter.ViewHolder holder, int position) {
