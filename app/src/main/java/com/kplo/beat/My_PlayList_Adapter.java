...
public class My_PlayList_Adapter extends RecyclerView.Adapter<My_PlayList_Adapter.ViewHolder> {
    ...
    My_PlayList_Adapter(ArrayList<Recent_Main_Item> list) {
        mData = list ;
    }


    @Override
    public My_PlayList_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;

        View view = inflater.inflate(R.layout.recycler_view_item_user_playlist, parent, false) ;
        My_PlayList_Adapter.ViewHolder vh = new My_PlayList_Adapter.ViewHolder(view) ;

        return vh ;
    }

    @Override
    public void onBindViewHolder(@NonNull My_PlayList_Adapter.ViewHolder holder, int position) {
