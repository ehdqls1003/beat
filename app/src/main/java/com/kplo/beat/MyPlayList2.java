...
public class MyPlayList2 extends AppCompatActivity implements My_PlayList_Adapter2.MyRecyclearViewClickListener {


    My_PlayList_Adapter2 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playnum = intent.getExtras().getInt("playnum");

        p_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyPlayList2.this, Playing.class);
    ...
    private void recent_music() {
        ...
        call.enqueue(new Callback<ArrayList<Recent_Main_Item>>() {
            ...
            public void onResponse(Call<ArrayList<Recent_Main_Item>> call, Response<ArrayList<Recent_Main_Item>> response) {
                ...
                Call<ArrayList<playlistmusic>> call2 = retrofitAPI.User_play_list3(playnum);
                call2.enqueue(new Callback<ArrayList<playlistmusic>>() {
                    @Override
                    public void onResponse(Call<ArrayList<playlistmusic>> call, Response<ArrayList<playlistmusic>> response) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(MyPlayList2.this,LinearLayoutManager.VERTICAL,false)) ;

                        // 리사이클러뷰에 SimpleTextAdapter 객체 지정.
                        adapter = new My_PlayList_Adapter2(postResponse2) ;
                        recyclerView.setAdapter(adapter) ;

                        //이거안해주면 리스너안먹힘
                        adapter.setOnClickListener(MyPlayList2.this);


                    }

                    @Override
                    public void onFailure(Call<ArrayList<playlistmusic>> call, Throwable t) {
