...
public class User_like_playlist_Adapter extends RecyclerView.Adapter<User_like_playlist_Adapter.ViewHolder> {
    ...
    User_like_playlist_Adapter(ArrayList<Recent_Main_Item> list) {
        mData = list ;
    }


    @Override
    public User_like_playlist_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;

        View view = inflater.inflate(R.layout.recycler_view_item_user_playlist, parent, false) ;
        User_like_playlist_Adapter.ViewHolder vh = new User_like_playlist_Adapter.ViewHolder(view) ;

        return vh ;
    }

    @Override
    public void onBindViewHolder(@NonNull User_like_playlist_Adapter.ViewHolder holder, int position) {
