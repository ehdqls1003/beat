...
public class Search_more extends AppCompatActivity implements My_PlayList_Adapter.MyRecyclearViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Search_more.this, Playing.class);
        ...
        call.enqueue(new Callback<ArrayList<Recent_Main_Item>>() {
            ...
            public void onResponse(Call<ArrayList<Recent_Main_Item>> call, Response<ArrayList<Recent_Main_Item>> response) {
                ...
                if (postResponse != null) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(Search_more.this, LinearLayoutManager.VERTICAL, false));

                    // 리사이클러뷰에 SimpleTextAdapter 객체 지정.
                    adapter = new My_PlayList_Adapter(postResponse);
                    recyclerView.setAdapter(adapter);
                    //이거안해주면 리스너안먹힘
                    adapter.setOnClickListener(Search_more.this);
                }
