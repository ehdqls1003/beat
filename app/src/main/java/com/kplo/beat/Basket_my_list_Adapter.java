...
public class Basket_my_list_Adapter extends RecyclerView.Adapter<Basket_my_list_Adapter.ViewHolder> {
    ...
    Basket_my_list_Adapter(ArrayList<playlist> list) {
        mData = list ;
    }


    @Override
    public Basket_my_list_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext() ;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) ;

        View view = inflater.inflate(R.layout.recycler_view_item_basketadd, parent, false) ;
        Basket_my_list_Adapter.ViewHolder vh = new Basket_my_list_Adapter.ViewHolder(view) ;
    ...
    @Override
    public void onBindViewHolder(@NonNull Basket_my_list_Adapter.ViewHolder holder, int position) {
