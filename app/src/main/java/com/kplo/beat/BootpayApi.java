...
import com.kplo.beat.model.request.RequestLink;
import com.kplo.beat.model.request.SubscribeBilling;
import com.kplo.beat.model.request.SubscribeBillingReserve;
import com.kplo.beat.model.request.Token;
import com.kplo.beat.model.request.User;
...
//    private final String URL_NAVERPAY_ITEM_RESPONSE = BASE_URL + "npay/product.json";
    ...
    public void getAccessToken() throws Exception {
        ...
        Log.e("토큰","application_id : "+application_id);
        Log.e("토큰","private_key : "+private_key);

        HttpClient client = HttpClientBuilder.create().build();
        Log.e("토큰","client : "+client);
        ...
        Log.e("토큰","resToken : "+resToken);

        if(resToken.status == 200)
            this.token = resToken.data.token;
        Log.e("토큰","resToken.data.token : "+resToken.data.token);
    }
